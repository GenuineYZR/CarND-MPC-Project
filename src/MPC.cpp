...
size_t delta_start = epsi_start + N; //It's a litte bit tricky here, delta_start is the indice of the first delta variable.
size_t a_start = delta_start + N - 1; // The number of each of the actuator is N - 1.
